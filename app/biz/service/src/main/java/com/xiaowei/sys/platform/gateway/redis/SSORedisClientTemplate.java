...
public class SSORedisClientTemplate {

    private static final Logger log = LoggerFactory.getLogger(SSORedisClientTemplate.class);

    private SSORedisDataSource redisDataSource;

    public SSORedisDataSource getRedisDataSource() {
        return redisDataSource;
    }

    public void setRedisDataSource(SSORedisDataSource redisDataSource) {
     ...
     * 通过key 删除指定的 field
     * @param key
     * @param field 可以是 一个 field 也可以是 一个数组
     * @return
     */
     ...
     * 通过key向list尾部添加字符串
     * @param key
     * @param string 可以使一个string 也可以使string数组
     ...
     * @param key
     * @param member 可以使一个string 也可以是一个string数组
     * @return
     */
