 ...
 * 选择属性列表
 */
public class DictAttrListRes implements Serializable {

    /**
     * 属性值
     */
    private List<DictAttrValueListVO> attrValue;
    /**
     * id 字典id.
     */
    private Long id;
    ...
    public List<DictAttrValueListVO> getAttrValue() {
        return attrValue;
    }

    public void setAttrValue(List<DictAttrValueListVO> attrValue) {
