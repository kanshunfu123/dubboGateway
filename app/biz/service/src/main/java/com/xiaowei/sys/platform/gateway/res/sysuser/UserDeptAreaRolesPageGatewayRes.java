...
import com.xiaowei.sys.platform.core.facade.service.vo.sysuser.SysUserPagingVO;

/**
 * Created by MOMO on 2018/9/13.
 */
public class UserDeptAreaRolesPageGatewayRes extends BasePage<SysUserPagingRes> {
